...
__attribute__((visibility("default"))) int ckb_auth_validate(
    ...
    if (auth_algorithm_id == AuthAlgorithmIdCkb) {
        ...
        const uint8_t my_signature[] = {
            0x1c, 0xcc, 0x76, 0x13, 0xbf, 0x62, 0xd6, 0xa8, 0x2b, 0x04, 0xf0,
            0x5e, 0xc8, 0xef, 0x9c, 0x20, 0x9d, 0xef, 0x6b, 0xe0, 0x69, 0x07,
            0x7e, 0x0a, 0x38, 0x68, 0x9a, 0xee, 0x41, 0xfb, 0x28, 0xc4, 0x8a,
            0x53, 0x9c, 0x46, 0xcc, 0x03, 0x3b, 0x18, 0x53, 0x0a, 0xa4, 0x87,
            0x5d, 0xdb, 0xa6, 0xf0, 0xb2, 0xda, 0xee, 0x5f, 0xee, 0xb0, 0x99,
            0xad, 0xf7, 0xc6, 0x0b, 0x40, 0xee, 0xe7, 0xb4, 0xf2, 0x19,
        };
        uint32_t my_signature_size = 65;
        const uint8_t my_message[] = {
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        };
        uint32_t my_message_size = sizeof(my_message);
        // uncompressed form of public key is 04a0e3f9160eea8624356cc931aaf2735209f22210eb7a9714ae7337da34000635370a24bdc773d265efe08dcf1d4184471ce8810641551a355117cc5744d3bb8d
        // compressed form of public key is 03a0e3f9160eea8624356cc931aaf2735209f22210eb7a9714ae7337da34000635
        // hash160 can be calculated from https://learnmeabitcoin.com/technical/public-key-hash
        const uint8_t my_pk_hash[] = {
            0xdf, 0x3c, 0x9b, 0x40, 0xbf, 0x80, 0x42, 0x08, 0x4e, 0xb5,
            0x49, 0xd3, 0xc6, 0x71, 0xf7, 0x7a, 0x26, 0x37, 0x32, 0xd7,
        };
